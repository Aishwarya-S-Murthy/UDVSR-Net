...
from basicsr.data.video_sr_dataset import VideoSRDataset
...
def create_dataset(dataset_opt):
    ...
    if dataset_type == 'VideoSRDataset':
        from basicsr.data.video_sr_dataset import VideoSRDataset
        return VideoSRDataset(dataset_opt)
    
    # ADD THIS SECTION FOR VALIDATION:
    if dataset_type == 'VideoSRTestDataset':
        from basicsr.data.video_test_dataset import VideoTestDataset
        return VideoTestDataset(dataset_opt)
    # ----------------------------------
